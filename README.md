A Unity package with a collection of various miscellaneous features, functions and tools. 
...
Everything is constantly WIP, so expect things to occasionally break/change between versions. Changes are documented in the [Changelog](CHANGELOG.md)
