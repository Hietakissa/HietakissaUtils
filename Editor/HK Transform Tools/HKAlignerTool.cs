...
namespace HietakissaUtils.Tools
{
    public class HKAlignerTool : HKTool
    {
        ...
        void CreateGUI()
        {
            ...
            HKToolsUtils.CreateLabel(page, "This tool hasn't been updated to the new HKTool system.", 16f);
        }
        ...
        void Draw()
        {
            ...
            if (!aligning) CreateButton(page, AlignSelectedToSurface, "Quick Align", 16f);
            ...
            CreateButton(cancelApplyHolder, StartAlign, aligning ? "Cancel" : "Start Dynamic Align", 16f, 1f);
            if (aligning) CreateButton(cancelApplyHolder, Apply, "Apply", 16f, 1f);
